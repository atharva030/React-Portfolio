    ...
    <div className="box-container">
        ...
        <div className="box box-projects">
           ...
           <img src={rnxg} alt="Web Projects"/>
            <span style={{color: "white"}}>RNXG Web Portal</span></a>
        </div>

        <div className="box">
           <a href="https://drive.google.com/file/d/12qusfDAsSsOtvUV4AQ7YQW7msk0BdnSb/view?usp=share_link" target="_blank"> 
           <img src={auton} alt="Front end Developer"/>
            <span style={{color: "white"}}>Web Developer @auton</span></a>
        </div>

        <div className="box">
            <a href="https://unstop.com/certificate-preview/287d9db1-cded-4dbe-a65e-dbfb73fd6a7d" target="_blank">
        ...
        <div className="box">
           <a href="https://www.rmageddon23.tech/" target="_blank">
            ...
            <span style={{color: "white"}}>Rmageddon 2023</span></a>
        </div>

        <div className="box">
        <a href="https://drive.google.com/file/d/1N8kh4WRiXy3mhXfzMRvnoxMdd8TfScts/view?usp=sharing" target="_blank">
        ...
        <div className="box">
        <a href="https://drive.google.com/file/d/16HfIqiQJ_T9rSOPbQVMoOFrA9fQWyS3d/view?usp=sharing" target="_blank">
